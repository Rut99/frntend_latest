...
//                           <li ><NavLink to="/teacher">Home</NavLink></li>
//                           <li><NavLink to="/teacher/Teacher">Teacher</NavLink></li>
//                           <li><NavLink to="/teacher/StudentReg">Student Registration</NavLink> </li>
//                           <li><NavLink to="/teacher/TeacherReg">Teacher Registration</NavLink></li>
//                           <li><NavLink to="/teacher/Result">Result</NavLink></li>
//                           {/* <li><NavLink to="localhost:3000/teacher/Contact">Contact</NavLink></li> */}
...
//             <Route  exact path="localhost:3000/teacher/Competition" component={Competition} />
//             <Route path="/teacher/TeacherReg" component={Teacher} />
//             <Route path="/teacher/StudentReg" component={Practice_challenge} />
//             {/* <Route exact path="localhost:3000/teacher/Contact" component={Contact} /> */}
